...
<meta name="keywords" content=" | yuzsekiz |
<meta HTTP-EQUIV="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" content="| yuzsekiz |"><script type="text/javascript">
//<![CDATA[
...
<body bgcolor="#000" marginwidth="0" marginheight="0" style="background: black url() no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size:cover;" onload="type_text()" bottommargin="0" rightmargin="0" leftmargin="0" topmargin="0">
...
<div class="sshHead">| yuzsekiz |</div>
<div id="1ssh">
<span id="mytext1">| yuzsekiz |</span><br>
<div id="ssh2" class="ssh">Enter Password:<span id="mytext2"> NM108 </span></div>

<div id="ssh3" class="ssh">[root@yuzsekiz]# <span id="mytext3">Last login: c_time </span></div>
<div id="ssh4" class="ssh">[root@yuzsekiz]# <span id="mytext4" style="color:#C04400;">Giriş başarısız ! <- Error ->  </span></div>
</br> </br>
<div id="ssh5" class="ssh" style="font-size:300%;" align="center"><span id="mytext5"> |SLM NİDOS GELDİ| </span></div>
<br>
<div id="ssh5" class="ssh" style="font-size:280%;" align="center"><span id="mytext5">https://www.facebook.com/hesapmertin<---- Follow us</span></div>
<br>
<div id="ssh6" class="ssh">[root@yuzsekiz]# <span id="mytext6"> Giriş başarılı...  </span></div>
</div>
<br>
<div id="2ssh">
<div id="ssh7" class="ssh">[root@yuzsekiz]# <span id="mytext7"><center><h1>| yuzsekiz |</h1><br> IP adress: 108.86.58.973

</center><br>| yuzsekiz |<br>
...\\Derecelendirme: 108<br>
...\\Sistem türü: 64 bit İşletim Sistemi<br>
...\\Windows sürümü: Windows 10<br>
...\\Yüklü bellek (RAM): 4.00 GB ! <br>
...[ Hiç bir şey imkansız değildir.<br>
...[ Ben Dünya'ya insanların açıklarını kapatmak için gelmedim,<br>
...[ Onların açıklarını kullanmak için geldim... <br>
<br> <br></span></div><div id="ssh5" class="ssh" style="font-size:280%;" align="center"><span id="mytext5">Turk</span></div>
<center><br><p> </div></center><div id="ssh10" class="ssh" style="padding-left:5px;">[root@yuzsekiz]# <span id="mytext10">---> <br>
</span></div>
</div>
